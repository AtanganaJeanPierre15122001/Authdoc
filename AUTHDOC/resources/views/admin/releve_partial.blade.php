...
<head>
    ...
    <style>
        ...
        * {
        ...
        .print-table {
            width: 80%;
            /* occuper 80% de la page */
            margin: 0 auto;
            /* pour centrer la table */
        ...
        <div class="contents">
            ...
            <header class="w-100 d-flex fle x-column header">
                <section class="w-100 d-flex align-items-center justify-content-between">
                    <div id="contentDiv3" class="d-flex content-state-data flex-column align-items-center">
                        <span> REPUBLIQUE DU CAMEROUN <br> </span>
                        <span> Paix - Travail - Patrie <br></span>
                        <span> ---------------------------<br> </span>
                        <span> UNIVERSITE YAOUNDE 1 </span>
                    </div>
                    <div class="d-flex logo content-uy1-logo d-flex justify-content-center align-items-center">
                        <img src="assets_admin/img/UyLogo.png" alt="university of yaounde 1" class="img-fluid" />

                    </div>

                    <div id="contentDiv" class="d-flex content-state-data flex-column align-items-center">
            ...
            <section id="section 0" class="w-100 d-flex flex-column align-items-center py-4"
            ...
            <main class="w-100 d-flex flex-column align-items-center">
                ...
                <section id="section1" class="w-100">
                    ...
                    <section class="w-100 d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex form-item">
                            ...
                            <div id="contentDiv5" class="form-value ps-4 pt-1 text-uppercase">
                                <span class="fs-5 fw-bolder bold_part">
                                    <strong> Matricule:
                                    </strong>{{ isset($etudiant) ? $etudiant->matricule : '' }}</span> <br>
                    ...
                    <div class="d-flex form-item">
                        ...
                        <div class="d-flex flex-column">
                            <span class="fs-5 fw-bolder bold_part">
                                <strong> Né(e) le:
                                </strong>{{ isset($etudiant) ? $etudiant->date_naissance : '' }}</span> <br>
                    ...
                    <section class="w-100 d-flex align-items-center justify-content-between">
                        <div class="d-flex form-item me-5 pe-5 ">
                            <div class="d-flex flex-column">
                                <span class="fs-5 fw-bolder bold_part"> <strong>Niveau
                    ...
                    <section class="w-100 d-flex align-items-center justify-content-between">
                        <div class="d-flex form-item">
                            <div class="d-flex flex-column">
                                <span class="fs-5 fw-bolder bold_part">
                                    <strong> Spécialité:</strong>{{ isset($releve) ? $etudiant->specialite : '' }}
                                </span> <br>
                        ...
                        <div id="contentDiv6" class="form-value ps-4 pt-1 text-uppercase">
                            <span class="fs-5 fw-bolder bold_part">
                                <strong> Annee Academic:</strong>
                                {{ isset($releve) ? $releve->annee_academique : '' }}</span> <br>
                            <span class="english_subtitle">
                                <div class="form-value ps-4 pt-1">
                ...
                <section class=" w-100 d-flex flex-column align-items-center"style="text-align:center;">
                ...
                <section id="section1" class="w-100 d-flex flex-column" style="font-size: 10px;">
                    <div class="d-flex">
                        <div><u> Légende: </u></div>
                        <div class="d-flex flex-column">
                    ...
                    <div class="d-flex ">
                        <div class="content-recap w-100 mt-2 bloc">
                            ...
                            <div id="contentDiv8" class="Qrcode">

                                <img src="data:image/png;base64,{{ base64_encode(\SimpleSoftwareIO\QrCode\Facades\QrCode::size(150)->generate($hmacInfo)) }}"
                                    alt="QR Code">
                            </div>
                    ...
                    <div style="font-size: medium;">NB:il n'est delivre qu'un seul exemplaire de releve de notes.Le
                        titulaire peut etablir et faire certifier des copies conformes.Only one transcript shall be
                        delivered.It is the owner's interest to make certified true copies</div>
