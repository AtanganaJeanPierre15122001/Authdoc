                    ...
                    <ul class="navbar-nav navbar-right">
                        ...
                        <li class="dropdown"><a href="#" data-toggle="dropdown"
                                class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                    src="" class="user-img-radious-style"> <span
                ...
                <div class="main-sidebar sidebar-style-2">
                    <aside id="sidebar-wrapper">
                        <div class="sidebar-brand">
                            <a href="index.html"> <img alt="image" src="assets_admin/img/logo.png" class="header-logo" />
                                ...
                                <div class="col-12">
                                    ...
                                    @if ($method == 'search')
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body bootstrap-select-1">
                                                    ...
                                                    <form id="hidden_form" method="POST"
                                                        action="{{ route('admin.attestation') }}"
                                        ...
                                        <div class="col-md-5 ">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">Ajouter une attestation</h4>
                                                </div>
                                                <!--end card-header-->
                                                <div class="card-body bootstrap-select-1">
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label class="mb-2">Ajouter un attestation via fichier
                                                                Excel</label>
                                                            <a href="{{ route('admin.ajout_excel') }}"
                                                                class="btn btn-primary w-100 mb-2">Excel</a>
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label class="mb-2">Ajouter un attestation
                                                                manuellement</label>
                                                            <a href="{{ route('admin.ajout_manuel') }}"
                                                                class="btn btn-primary w-100 mb-2">Manuel</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end card-body-->
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @else
                                                                @foreach ($attestations as $attestation)
                                                                    <input type="hidden" id="relMat" name="relMat"
                                                                        value="{{ $attestation->id_releve }}">
                                                                    <tr id="releveRow-{{ $attestation->id_attestation }}">
                                                                        <td class="etu-idRel">
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ route('admin.view_attestation', ['mat' => $attestation->matricule, 'idA' => $attestation->id_attestation]) }}"
                                                                                ...
                                                                                attestation</a>
                                                                            <button type="button"
                                                                                class="btn btn-danger btn-delete2"
                                                                                data-rel-id="{{ $attestation->id_releve }}">
