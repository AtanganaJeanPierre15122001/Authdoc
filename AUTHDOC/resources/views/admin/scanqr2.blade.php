                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown active"><a class="nav-link" href="{{route('admin.scanAttestation')}}">Attestation</a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="description wow fadeInLeft">
                                            ...
                                            <form action="{{route('admin.qr2')}}" method="post" id="formQr">
                                                @csrf
                                                <input type="hidden" name="data" id="data">
                                                <br />
                                                {{-- <input name="ok">--}}

                                                <button class="btn btn-primary" type="button" id="scanButton" onclick="scanner2()">Scanner le document</button>
                                                <button class="btn btn-danger" type="button" id="continue" data-url="{{ route('admin.continuescan2') }}" disabled>Continuer</button>
                            ...
                            <div class="container">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-8 text-center">
                                        <h4>Exemple d'attestation</h4>
                                        <img src="assets_admin/img/attestation.JPG" class="img-fluid" alt="Exemple d'image" style="max-width: 300px; margin: 20px 0;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card">
                                            <form action="{{route('admin.ocrattestation')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card-header">
