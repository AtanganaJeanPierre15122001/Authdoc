...
{{--                        </li>--}}
        ...
        * {
        ...
        @media (max-width: 767px) {
            ...
            .content-state-data span,
            .content-uy1-logo img {
                font-size: 12px;
            }
    ...
    <div class="d-flex container-lg flex-column py-5 px-5 default_option">
        <div class="contents">
            ...
            <section class="w-100 d-flex flex-column align-items-center py-4" style="padding-bottom: 0px !important">
                ...
                <span>PB/P.O. Box 812 Yaoundé CAMEROUN : Tel: 222-234-496 / Email: diplome@facsiences.uy1.cm</span>
...
<main class="w-100 d-flex flex-column align-items-center">
    ...
    <section class="w-100 mt-2">
        <table class="w-100 table print-table">
            <thead>
                <tr>
                    <th><span>Code UE</span></th>
                    <th><span>Intitulé de l'UE / UE Title</span></th>
                    <th><span>crédit<br>credit</span></th>
                    <th><span>Moy / 100</span></th>
                    <th><span>Mention<br>Grade</span></th>
                    <th><span>Semestre<br>Semester</span></th>
                    <th><span>Année<br>Year</span></th>
                    <th><span>Décision<br>Decision</span></th>
                </tr>
            </thead>
            <tbody>
                @if (isset($resultats))
    ...
    <section class="w-100 d-flex flex-column align-items-center">
        <span class="w-100 decision-data d-flex flex-column w-auto">
            ...
            <span>Moyenne Générale Pondérée (MGP): {{ isset($releve) ? $releve->moy_gen_pon : '' }} /4</span>
            
            <span>Decision: <b>{{ isset($releve) ? $releve->decision_rel : '' }}</b></span>
                    </span>
                </section>
                    ...
                    <div class="d-flex">
                        <div class="content-recap w-100 mt-3 bloc">
                            <table class="table table-sm w-100">
                                <thead>
                                    <th><span>Note / 100</span></th>
                                    <th><span>Cote</span></th>
                                    <th><span>Qualité<br>de point</span></th>
                                    <th><span class="px-5">Mention</span></th>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>>= 80</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">A-</td>
                                        <td>3.70</td>
                                        <td rowspan="2"><span>Bien</span></td>
                                    </tr>
                                    <tr>
                                        <td>70 - 74</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">B</td>
                                        <td>3.00</td>
                                        <td rowspan="2"><span>Assez Bien</span></td>
                                    </tr>
                                    <tr>
                                        <td>60 - 64</td>
                                        <td class="text-center">B-</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>2.30</td>
                                        <td rowspan="2"><span>Passable</span></td>
                                    </tr>
                                    <tr>
                                        <td>50 - 54</td>
                                        <td class="text-center">C</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">A-</td>
                                        <td>1.70</td>
                                        <td rowspan="3"><span class="px-2">Crédit Capitalisé Mais non transferable</span></td>
                                    </tr>
                                    <tr>
                                        <td>40 - 44</td>
                                        <td class="text-center">B+</td>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2"><span>0.00</span></td>
                                        <td rowspan="2"><span>Echec</span></td>
                                    </tr>
                                    <tr>
                                        <td>< 30</td>
